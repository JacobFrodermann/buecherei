...
packages:
  ...
  /eslint-config-react-app/7.0.1_6lgrqu2p7dfkc6bf7ncm5xpzs4:
    ...
    dependencies:
      ...
      eslint-plugin-jest: 25.7.0_y4suuy5qvh7rdq4omekgk76a2q
  ...
  /fork-ts-checker-webpack-plugin/6.5.2_d6mwqtvpzyptsbgadmdtsiamly:
  ...
  /jsonfile-updater/3.1.0:
    resolution: {integrity: sha512-G6DB55KX4Cc5t0Zpg4kfy2b3N592fahyoUJz5rk4VmS8lccXskgUbjUEX51iXMc6gh6sE7urmXWJsW6EqDozVQ==}
    engines: {node: '>=6'}
    dev: false
  ...
  /react-dev-utils/12.0.1_d6mwqtvpzyptsbgadmdtsiamly:
  ...
  /ts/0.2.2_typescript@4.9.5:
    resolution: {integrity: sha512-cftcjXvrxBi6TJxwXjKZXm9g8eNClLQuEN+Yt90o0baDCpRDCCYsDEz3Uhpc5D2Wx1IZE1G1B4M8GY3OLsczzQ==}
    hasBin: true
    peerDependencies:
      typescript: 2.* || 3.*
    dependencies:
